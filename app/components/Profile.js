...
Explain every decision in plain English.`
  ...
  const competitions = [
    { name: 'Weekly Championship',  result: '🏆 1st place', prize: '+8,400 $AGENT', ret: '+341%', date: 'Week 12' },
    { name: 'BTC Specialist Cup',    result: '🥈 2nd place', prize: '+2,100 $AGENT', ret: '+198%', date: 'Week 11' },
    { name: 'Beginner League',       result: '🥉 3rd place', prize: '+800 $AGENT',   ret: '+89%',  date: 'Week 10' },
    { name: 'Meme Coin Madness',     result: '😬 14th',      prize: '—',             ret: '-12%',  date: 'Week 9'  },
  ]
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-6 mb-4">
        ...
        {/* Share URL */}
        <div className="mt-4 bg-gray-50 rounded-lg px-3 py-2 flex items-center justify-between">
